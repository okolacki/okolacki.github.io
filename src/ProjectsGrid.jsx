...
        <div className="p-6 relative mb-10 overflow-hidden rounded-md bg-gradient-to-br from-blue-100 to-pink-300 h-auto md:h-[50vh] w-full md:w-[35vw] flex justify-center flex-col items-center transition duration-300 ease-in-out hover:scale-105">
